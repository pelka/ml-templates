# -*- coding: utf-8 -*-
"""
Created on Thu Nov 24 11:10:43 2022
...
# Ajustar el modelo de arboles de desicion en el conjunto de entrenamiento
...
for i, j in enumerate(np.unique(y_set)):
    plt.scatter(X_set[y_set == j, 0], X_set[y_set == j, 1],
                c = ListedColormap(('red', 'green'))(i), label = j)
plt.title('Random Forest (Conjunto de Testing)')
plt.xlabel('Edad')
plt.ylabel('Sueldo Estimado')
plt.legend()
plt.show()